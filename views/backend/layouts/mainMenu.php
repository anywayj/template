...
if (!$webUser->isGuest) {
    ...
    $menuItems = [
        ['label' => Yii::t('yii', 'Home'), 'url' => Yii::$app->request->getBaseUrl() . '/admin.php', 'icon' => 'home'],
        ['label' => Yii::t('yii', 'Index.php'), 'url' => Yii::$app->request->getBaseUrl() . '/index.php'],
    ];
if ($webUser->isGuest) {
    $menuItems = [
    ['label' => Yii::t('yii', 'Index.php'), 'url' => Yii::$app->request->getBaseUrl() . '/index.php', 'icon' => 'home'],
];
